...
RCT_EXPORT_VIEW_PROPERTY(scaleMinima, NSDictionary) \
RCT_EXPORT_VIEW_PROPERTY(visibleXRangeMinimum, NSNumber) \
RCT_EXPORT_VIEW_PROPERTY(visibleXRangeMaximum, NSNumber) \
RCT_EXPORT_VIEW_PROPERTY(visibleXRange, NSDictionary) \
